...
public class GoodsRepository {
    private final String QUERY_TO_FIND_ALL_GOODS = "SELECT * FROM Goods";
    private final String QUERY_TO_INSERT_VALUES = "INSERT INTO Goods (good_name, type) VALUES('%s', %d)";
    private final String QUERY_TO_FIND_BY_ID = "SELECT * FROM Goods WHERE good_id = %d";
    private final String QUERY_TO_UPDATE_BY_ID = "UPDATE Goods SET good_name = '%s', type = %d WHERE good_id = %d";
    private final String QUERY_TO_DELETE_BY_ID = "DELETE FROM Goods WHERE good_id = %d";
    private final String MESSAGE_FOR_UNSUCCESSFUL_DELETION = "No good with id = %d";
    private final String MESSAGE_FOR_SUCCESSFUL_DELETION = "Good with id = %d was successfully deleted";
